...
namespace XiheFramework {
    public static class InputSvc {
        public static void AssignKeyMap(KeyActionTypes action, KeyCode key) {
        ...
        public static bool GetKeyDown(KeyActionTypes keyAction) {
            return Game.Input.GetKeyDown(keyAction);
        }

        public static bool GetKeyHold(KeyActionTypes keyAction) {
            return Game.Input.GetKey(keyAction);
        }

        public static bool GetKeyUp(KeyActionTypes keyAction) {
